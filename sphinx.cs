...
namespace Riddle
{
  class Sphinx
  {
      public static string[] riddles = {"What has to be broken before you can use it?", "What month of the year has 28 days?", "I’m tall when I’m young, and I’m short when I’m old. What am I?", "What is full of holes but still holds water?", "What question can you never answer yes to?"};
      public static string[] answers = {"an egg", "all of them", "a candle", "a sponge", "are you asleep yet?"};
      ...
      static void Main() 
      {
        ...
        do
        {
          ...
          if(userAnswer.ToLower() == answers[index])
          {
            Console.WriteLine("Sphinx has been defeated");
            index = random.Next(5);
          }
          else
          {
            Console.WriteLine("Sphinx eats user");
          }
        } while (userAnswer != "x");
